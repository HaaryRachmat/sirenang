                                    ...
                                    foreach ($kategori as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#edit<?= $value['id_kategori']; ?>"><i data-feather="edit"></i></button>

                                                <button class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#delete<?= $value['id_kategori']; ?>"><i data-feather="trash-2"></i></button>
                                            </td>
                                        </tr>
                                    <?php } ?>
...
<?php foreach ($kategori as $key => $value) {  ?>
    ...
    <div id="edit<?= $value['id_kategori']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form>
                                <div class="form-group">
                                    <label class="form-label">Kategori</label>
                                    <input value="<?= $value['nama_kategori']; ?>" type="text" class="form-control" name="nama_kategori" placeholder="Masukkan Kategori">
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php foreach ($kategori as $key => $value) {  ?>
    <div id="delete<?= $value['id_kategori']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
